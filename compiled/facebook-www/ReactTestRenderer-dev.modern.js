...
__DEV__ &&
  (function () {
      ...
      switch (finishedWork.tag) {
        ...
        case 5:
          ...
          if (
            ...
            try {
              (existingHiddenCallbacks.type = type),
                (existingHiddenCallbacks.props = current);
            } catch (error$28) {
              captureCommitPhaseError(
                finishedWork,
                finishedWork.return,
          ...
          if (flags & 4) {
            try {
              if (null !== finishedWork.memoizedState)
                if (
                  ((type = finishedWork.memoizedProps.suspenseCallback),
                  "function" === typeof type)
                ) {
                  var retryQueue = finishedWork.updateQueue;
                  null !== retryQueue && type(new Set(retryQueue));
                } else
                  void 0 !== type &&
        ...
        case 22:
          flags & 512 &&
            null !== current &&
            safelyDetachRef(current, current.return);
          type = null !== finishedWork.memoizedState;
          retryQueue = null !== current && null !== current.memoizedState;
          var prevOffscreenSubtreeIsHidden = offscreenSubtreeIsHidden,
            prevOffscreenSubtreeWasHidden = offscreenSubtreeWasHidden;
          offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden || type;
          offscreenSubtreeWasHidden =
          ...
          if (
            ...
            a: for (current = null, root = finishedWork; ; ) {
              if (5 === root.tag) {
                ...
                if (null === current)
                  try {
                    root.stateNode.isHidden = type ? !0 : !1;
                  } catch (error$22) {
                    captureCommitPhaseError(
                      finishedWork,
                      finishedWork.return,
    ...
    (function () {
      var internals = {
        bundleType: 1,
        version: "19.0.0-www-modern-4ea12a11-20240801",
        rendererPackageName: "react-test-renderer",
        currentDispatcherRef: ReactSharedInternals,
        findFiberByHostInstance: getInstanceFromNode,
        reconcilerVersion: "19.0.0-www-modern-4ea12a11-20240801"
      };
    ...
    exports.version = "19.0.0-www-modern-4ea12a11-20240801";
  })();
